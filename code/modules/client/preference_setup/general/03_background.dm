...
/datum/category_item/player_setup_item/general/background/content(var/mob/user)
	...
	if(!pref.existing_character)
		. += "Kiel City is on the planet Pollux, and is located in Orcal Spax Colony B, in the Vetra star system. You may choose a different background. Social class and the system you are born in cannot be changed once set.</br><br>"

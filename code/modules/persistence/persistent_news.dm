...
/datum/feed_network/New()
	CreateFeedChannel("Kiel Standard", "NanoTrasen News Authority", 1, 1, "New Issue of Kiel Standard!", 1)
...
//Maybe needed? Not sure.
	...
	var/city_anchors = list()		// list of uids of editors for kiel standard
	var/city_anchor_managers = list()	// list of uids of managers for kiel standard
...
/datum/economy/news/New()
	...
	for(var/datum/feed_channel/F in news_network.network_channels)
		if(F.channel_name == "Kiel Standard")
			city_newspaper = F
			break
...
/datum/economy/news/proc/save_main_news()
	...
	if(!city_newspaper)
		message_admins("Save: Could not find Kiel Standard.", 1)
		return
...
/datum/economy/news/proc/load_main_news()
	...
	if(!city_newspaper)
		message_admins("Load: Could not find Kiel Standard.", 1)
		return

...
/obj/item/weapon/paper/Court
	name = "Judgement"
	info = "<font face=\"Verdana\" color=black><center><H2>Kiel City High Court</H2><BR><B>Official Court Ruling</B><BR><img src = ntlogo.png><BR></center><BR><HR><BR><font size = \"1\">The following constitutes an official, legally binding decision of the Kiel High Court.<BR><BR>On the following charges, the defendant is hereby found:</font><BR><BR><font size = \"1\"><B>(Guilty - G)<BR>(Not Guilty - NG)</B></font><BR><HR><BR><span class=\"paper_field\"></span><BR><BR><HR><BR><font size = \"1\"><BR><B>So orders the Kiel City High Court:</B></font><BR><BR><BR><B><font size = \"1\">Judge&#39;s signature:</font></B><BR><span class=\"paper_field\"></span><BR><BR><HR><BR><font size = \"1\"><B><U>Official Document of Kiel City Court. Forgery of this document is a crime.</U></B></font></font>"

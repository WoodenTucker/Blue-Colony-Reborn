...
/datum/bounty/prison_mining/phoron // yes science is on it too
	...
	description = "Kiel City laboratories requires phoron deposits for research purposes, please send a supply when you can."
...
/datum/bounty/prison_mining/phoron_healthcare // yes even the hospital
	...
	description = "Kiel City hospital's pharmacist sector requires large amounts of phoron to keep productivity running, please send supplies."
